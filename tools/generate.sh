#!/bin/bash
 ...
 # copy bundles
  ...
  replaceInConfig=(
    's/mysql:host=localhost;dbname=uc_simple_blog/mysql:host=INSTALL_DB_ADDRESS;dbname=INSTALL_DB_NAME/g'
    's/\/admin-panel\//\/INSTALL_ADMIN_PATH\//g'
    's/\/ukrcms\/simple-blog/INSTALL_SITE_PATH/g'
